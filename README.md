...
> 本專案需以 Google 帳號登入才能操作。以下為公開分享報告連結，**無需登入**即可直接檢視真實分析結果，供面試官快速了解工具輸出效果。

**👉 [點此查看範例報告](https://nuxt-seo-analyzer.pages.dev/share/883b7e09-30a8-4b29-b93a-121f4a545f7f)**

範例分析對象：`kqkqbet.com.br`（共 4 頁）

| 指標 | 結果 |
|------|------|
| 🌐 整站 Google 收錄 | 7 網頁 / 22 圖片（Serpapi） |
| 🏷️ Meta 標籤評分 | **100 分** |
| ⚡ Core Web Vitals | 72 分（LCP 7.6s 過慢） |
| 🔎 Google 索引狀態 | 已收錄 |
...
├── analyzers/             # meta, cwv, robots, schema, headings, images, indexing
├── indexing/              # parse-keys, serpapi, engine, cache
└── export/                # csv, markdown
