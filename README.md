                ...
                <table>
                  <tr>
                    <td width="50%">
                      <h3>🔍 分析功能</h3>h3>
                      <ul>
                        <li><strong>頁面探索</strong>strong>：自動掃描 <code>sitemap.xml</code>code> + 首頁連結，合併去重</li>li>
                      <li><strong>7 大 SEO 指標</strong>strong>：Meta 標籤、Core Web Vitals、Google 索引、標題結構、圖片 Alt、Schema、Robots/Sitemap</li>li>
                      <li><strong>SSE 即時串流</strong>strong>：每頁分析完成立即推送，進度條即時更新</li>li>
                      <li><strong>整站收錄量</strong>strong>：Google 網頁數 / 圖片數查詢，24 小時快取</li>li>
                      </ul>ul>
                    </td>td>
                <td width="50%">
                <h3>🧠 AI 與匯出</h3>h3>
                <ul>
                  <li><strong>整站中文健診報告</strong>strong>：所有頁面完成後，GPT-4o-mini 彙整產出一份繁體中文 SEO 報告</li>li>
                  <li><strong>CSV 匯出</strong>strong>：UTF-8 with BOM，每頁一列含 12 欄位，Excel 開啟無亂碼</li>li>
                  <li><strong>Markdown 匯出</strong>strong>：整站報告 + AI 摘要 + 各頁問題清單，適合貼入 Notion / 客戶提案</li>li>
                  <li><strong>歷史紀錄</strong>strong>：所有分析儲存於 Supabase，可回顧完整報告</li>li>
                </ul>ul>
                </td>td>
                  </tr>tr>
                </table>table>
